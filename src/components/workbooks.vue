      ...
      <div class="d-flex mb-3">
        ...
        <div>
          <el-button
            ...
            @click="toggleOffers = !toggleOffers"
          >
            <div class="d-flex">
              <div>
                <svg
          ...
          <el-collapse accordion>
            <div class="row">
              <div
                ...
                :name="offer.id"
              >
                <el-collapse-item class="mb-3 p-3">
                  <template slot="title">
                    <div
                      class="d-flex justify-content-between collapse-title p-3"
                    >
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        xmlns:xlink="http://www.w3.org/1999/xlink"
    ...
    addOfferToCart(offer) {
      ...
      offer.products.map((prod) => {
        ...
        products.push({
          ...
          name: prod.name,
          id: prod.id,
          size: this.sizes.find((ele2) => ele2.id == prod.pivot.product_size_id)
            .name,
