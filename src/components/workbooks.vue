  ...
  <div class="workbooks mt-2">
    <template v-if="!toggleOffers">
      <div class="d-flex mb-3">
        <div style="flex: 1">
          <h3 class="text-right mb-0 d-block">
            <div class="d-flex">
              <div>
                <svg
              ...
              <div>
                <h6
                  style="font-size: 20px;padding-top: 5px;font-family: 'CairoBold';"
                >
                  المنيو
                </h6>
              </div>
        ...
        <div>
          <el-button style="padding: 5px 11px" @click="toggleOffers = !toggleOffers">
            <div class="d-flex">
              <div>
                <svg
              xmlns="http://www.w3.org/2000/svg"
              ...
              style="enable-background:new 0 0 511.548 511.548;    margin-top: 5px;"
              xml:space="preserve"
              width="22"
              height="22"
            >
      ...
      <div class="d-flex mb-3">
        <div style="flex: 1">
          <div class="d-flex">
            ...
            <div>
              <h6
                style="font-size: 20px;padding-top: 5px;font-family: 'CairoBold';color: #FE5634 !important;"
              >
                العروض
              </h6>
            </div>
        ...
        <div>
          ...
          <el-button style="padding: 5px 11px" @click="toggleOffers = !toggleOffers" v-if="toggleOffers">
            <div class="d-flex">
              <div>
                  ...
                  <template slot="title">
                    <div class="d-flex justify-content-between collapse-title">
                      <svg
                        ...
                        y="0px"
                        viewBox="0 0 511.548 511.548"
                        style="enable-background:new 0 0 511.548 511.548;    margin-top: 10px;"
                        xml:space="preserve"
                        width="30"
                        height="30"
                      >
                      ...
                      <h6>
                        <span
                          ><el-button
                            ...
                            @click.stop="addOfferToCart(offer)"
                          >
                            <span class="offer-price"> {{ offer.price }} </span>
                            <span class="offer-add"> إضافة </span>
                          </el-button></span
                        >
                      </h6>
                    </div>
                    ...
                    <div class="d-flex">
                      ...
                      <div>
                        <span style="color: #fe5634 !important">
                          {{
                            sizes.find(
                              (ele) => ele.id == product.pivot.product_size_id
                            ).name
                          }}
                        </span>
                      </div>
